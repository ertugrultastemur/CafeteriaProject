...
namespace Business.DependencyResolvers.Autofac
{
    public class AutofacBusinessModule : Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<EfMunicipalityDal>().As<IMunicipalityDal>().SingleInstance();
            builder.RegisterType<MunicipalityManager>().As<IMunicipalityService>().SingleInstance();
